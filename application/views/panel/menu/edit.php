<div class="submit-address dashboard-list">
    <form method="POST" action="<?= base_url('panel/menu/update/').$menu['id']?>" id="operation_form">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group-main">
                    ...
                    <div class="form-group">
                        <input type="text" class="input-text form-control" name="menu" placeholder="Menu Name" value="<?= (!empty(set_value('menu'))) ? set_value('menu') : $menu['menu'] ?>" id="menu">
                    </div>
                </div>
            </div>
