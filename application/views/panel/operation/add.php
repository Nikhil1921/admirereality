<div class="submit-address dashboard-list">
    <form method="POST" action="<?= base_url('panel/operation/add')?>" id="operation_form">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group-main">
                    ...
                    <div class="form-group">
                        <input type="text" class="input-text form-control" name="type" placeholder="Operation Type" value="<?= set_value('type')?>" id="type">
                        <?= form_error('type')?>
                    </div>
                </div>
            </div>
