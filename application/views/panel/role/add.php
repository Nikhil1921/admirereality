<div class="submit-address dashboard-list">
    <form method="POST" action="<?= base_url('panel/role/add')?>" id="role_form">
                ...
                <div class="col-lg-12 col-md-6 col-sm-6">
                    <div class="form-group-main">
                        ...
                        <div class="form-group">
                            <input type="text" class="input-text form-control" name="role" placeholder="Role Name" value="<?= set_value('role')?>" id="role">
                            <?= form_error('role')?>
                        </div>
                    </div>
                </div>
