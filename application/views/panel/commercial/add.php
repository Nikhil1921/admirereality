<div class="submit-address dashboard-list">
    <form method="POST" action="<?= base_url('panel/commercial/add') ?>" enctype="multipart/form-data" id="property_form">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control search-fields" name="type" id="type">
                            <option value="office_space" <?= set_select('type', "office_space", False) ?>>Office Space</option>
                            <option value="shop" <?= set_select('type', "shop", False) ?>>Shop</option>
                            <option value="showroom" <?= set_select('type', "showroom", False) ?>>Showroom</option>
                        </select>
                        <?=  form_error('type') ?>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control search-fields" name="parking" id="parking">
                            <option value="0" <?= set_select('parking', 0, False) ?>>No</option>
                            <option value="1" <?= set_select('parking', 1, False) ?>>Yes</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
