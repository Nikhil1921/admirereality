            ...
            <div class="row pad-2">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control search-fields" name="room" id="room" disabled>
                            <option value="1" <?= ($property['room'] == 1 ) ? 'selected' : '' ?>>1</option>
                            <option value="2" <?= ($property['room'] == 2 ) ? 'selected' : '' ?>>2</option>
                            <option value="3" <?= ($property['room'] == 3 ) ? 'selected' : '' ?>>3</option>
                            <option value="4" <?= ($property['room'] == 4 ) ? 'selected' : '' ?>>4</option>
                        </select>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control search-fields" name="bathroom" id="bathroom" disabled>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="form-group">
                        ...
                        <select class="form-control search-fields" name="garage" id="garage" disabled>
                            <option value="0" <?= ($property['garage'] == 0 ) ? 'selected' : '' ?>>No Garage</option>
        ...
        <div class="row pad-20">
            ...
            <div class="row pad-20">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <a href="<?= base_url('panel/residential')?>" class="btn btn-md button-theme">Back to Properties</a>
                </div>
            </div>
        </form>
    </div>