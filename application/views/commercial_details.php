                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-40">
                        <div class="carousel-inner">
                            ...
                            <div class="<?= ($k == 0) ? 'active': ''?> item carousel-item" data-slide-number="0">
                                <img src="<?= asset() ?>img/properties/commercial/<?= $v ?>" class="img-fluid" alt="slider-properties">
                            </div>
                            <?php endforeach ?>
                        </div>
                        <ul class="carousel-indicators smail-properties list-inline nav nav-justified">
                            ...
                            <li class="list-inline-item <?= ($k == 0) ? 'active': ''?>">
                                <a id="carousel-selector-<?= $k ?>" class="<?= ($k == 0) ? 'selected': ''?>" data-slide-to="<?= $k ?>" data-target="#propertiesDetailsSlider">
                                    <img src="<?= asset() ?>img/properties/commercial/<?= $v ?>" class="img-fluid" alt="properties-small">
                                </a>
                            </li>
                            <?php endforeach ?>
                        </ul>
                                ...
                                <div class="floor-plans mb-50">
                                    ...
                                    <table>
                                        <tbody><tr>
                                            ...
                                            <td><strong>Buildup Area</strong></td>
                                            <td><strong>Super Builup Area</strong></td>
                                            <td><strong>Parking</strong></td>
                                        </tr>
                                        <tr>
                                            <td><?= $property['c_area'] ?></td>
                                            <td><?= $property['b_area'] ?></td>
                                            <td><?= $property['area'] ?></td>
                                            <td><?= ($property['parking']) ? $property['parking'] : "No Parking" ?></td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="property-details mb-40">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <ul>
                                            <li>
                                                <strong>Parking:</strong><?= ($property['parking']) ? $property['parking'] : 'No Parking' ?>
                                            </li>
                                            <li>
            ...
            <div class="sidebar-right">
                <div class="widget recent-properties">
                    ...
                    <div class="media mb-4">
                        <a class="pr-3" href="<?= base_url('commercial-property/'.urlencode($v['title']).'/'.my_crypt($v['id'],'e')) ?>">
                            <img class="media-object" src="<?= asset()?>img/properties/commercial/<?= explode(',', $v['multi_image'])[0] ?>" alt="small-properties">
                        </a>
                        <div class="media-body align-self-center">
                            ...
                            <div class="listing-post-meta">
                                <a href="<?= base_url('commercial-property/'.urlencode($v['title']).'/'.my_crypt($v['id'],'e')) ?>"><i class="fa fa-calendar"></i> <?= date("d-m-Y", strtotime($v['uploaded'])) ?> </a> | ₹ <?= $v['price'] ?>
                            </div>
                        </div>
                    </div>
                    <?php endforeach ?>
