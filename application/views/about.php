<div class="about-real-estate  content-area-5 pb-5">
    <div class="container">
...
<div class="testimonial bg-grea-3 pt-5 pb-5">
    <div class="container">
                  ...
                  <form action="#" method="GET" enctype="multipart/form-data">
                    <div class="row">
                      ...
                      <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <button type="button" class="btn btn-primary btn-md mt-3">Review Submit</button>
                      </div>
                    </div>
                  </form>
                </div>
